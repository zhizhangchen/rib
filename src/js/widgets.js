...
var BWidgetRegistry = {
    ...
    */
    ...
    ThumbnailsList: {
        parent: "SimpleList",
        paletteImageName: "jqm_thumbnails_list.svg",
        template: '<ul data-role="listview">',
        zones: [
            {
    ...
    ThumbnailsListItem: {
        ...
        paletteImageName: "jqm_thumbnails_list_item.svg",
    ...
    ListDivider: {
        ...
        allowIn: [ "SimpleList", "OrderedList", "ButtonList", "TextList", "IconList", "ThumbnailsList" ],
        properties: {
            text: {
