...
$(function () {
    ...
    pmUtils.exportProject = function () {
        ...
        if (typeof obj === "object") {
            // Delete the thumbnail when export, so that the package
            // can be elimilated, and thumbnail will be generated next
    ...
    pmUtils.updateThumbnail = function() {
        var c, d, s, pid;
